...
<template>
  <div class="login-container">
    <video
      :poster="require(`@/assets/images/login/video_cover.jpeg`)"
      loop
      autoplay
      muted
    >
...
export default defineComponent({
  ...
  setup() {
    ...
    //       console.log(store.state.user.name.toString())
    //       console.log(store.state.user.email.toString())
    //       console.log(store.state.user.token.toString())
    //       console.log(store.state.user.avatar.toString())
    //       console.log(store.state.user.introduction.toString())
    //       console.log(store.state.user.roles.toString())
    //       // router.push({
    //       //     path: state.redirect || '/',
