...
import { getRoutes, getRoles, delRole, updateRole, createRole } from '@/api/roles.ts'
  ...
  setup() {
    ...
    const confirmRole = async() => {
      ...
      if (isEdit) {
        ...
        await createRole({ role: state.role }).then(async(res: any) => {
